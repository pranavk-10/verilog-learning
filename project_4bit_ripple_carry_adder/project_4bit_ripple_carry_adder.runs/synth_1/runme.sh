...
HD_PWD='C:/Users/hp/.Xilinx/projects/project_4bit_ripple_carry_adder/project_4bit_ripple_carry_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_bit_ripple_carry_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source four_bit_ripple_carry_adder.tcl
