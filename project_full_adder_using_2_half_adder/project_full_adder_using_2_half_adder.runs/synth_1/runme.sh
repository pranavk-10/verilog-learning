...
HD_PWD='C:/Users/hp/.Xilinx/projects/project_full_adder_using_2_half_adder/project_full_adder_using_2_half_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_2HA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_adder_2HA.tcl
