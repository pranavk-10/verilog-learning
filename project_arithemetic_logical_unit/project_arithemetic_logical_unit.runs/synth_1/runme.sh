...
HD_PWD='C:/Users/hp/.Xilinx/projects/project_arithemetic_logical_unit/project_arithemetic_logical_unit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arithmetic_logical_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arithmetic_logical_unit.tcl
