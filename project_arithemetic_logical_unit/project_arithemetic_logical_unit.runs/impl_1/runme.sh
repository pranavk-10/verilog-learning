...
HD_PWD='C:/Users/hp/.Xilinx/projects/project_arithemetic_logical_unit/project_arithemetic_logical_unit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arithmetic_logical_unit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arithmetic_logical_unit.tcl -notrace
