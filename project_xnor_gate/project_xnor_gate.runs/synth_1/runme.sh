...
HD_PWD='C:/Users/hp/.Xilinx/projects/project_xnor_gate/project_xnor_gate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xnor_gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xnor_gate.tcl
